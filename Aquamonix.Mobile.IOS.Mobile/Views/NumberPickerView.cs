...
namespace Aquamonix.Mobile.IOS.Views
{
    ...
    public class NumberPickerView : AquamonixView
    {
        ...
        public NumberPickerView(int interval = 1) : base()
        {
            ...
            this.AddSubviews(this._hoursPicker);
        }
        ...
        public class HoursPickerViewModel : UIPickerViewModel
        {
            ...
            {
                return String.Format("{0}", (row), "hour");
            }
        }
