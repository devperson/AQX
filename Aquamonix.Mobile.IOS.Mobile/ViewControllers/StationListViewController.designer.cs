...
{
	[Register("StationListViewController")]
	partial class StationListViewController
	{
		private static readonly FontWithColor BoldCellTextFont = new FontWithColor(Fonts.BoldFontName, Sizes.FontSize8, Colors.AquamonixGreen);
		...
		private readonly StationListTableViewController _tableViewController = new StationListTableViewController();
